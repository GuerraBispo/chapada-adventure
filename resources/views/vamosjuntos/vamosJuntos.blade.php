        ...
        <div class="row">
            ...
            <div class="col-xl-6">
                <div class="ps-xl-4 ms-xl-2">
                    <div class="title-area mb-20 pe-xl-5 me-xl-5"><span class="sub-title style1">Vamos Juntos</span>
                        <h3 class="sec-title mb-20 pe-xl-5 me-xl-5 heading">Conhecer a Chapada das Mesas</h3>
