    ...
    <div class="container">
        <div class="mb-30 text-center text-md-start">
            <div class="row align-items-center justify-content-between">
                <div class="col-md-7">
                    <div class="title-area mb-md-0"><span class="sub-title">Dicas Adventure</span>
                        <h2 class="sec-title">Bares e Restaurantes</h2>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="swiper-slide">
                        <div class="blog-box th-ani">
                            ...
                            <div class="blog-box_content">
                                ...
                                <h3 class="box-title"><a href="blog-details.html">10 Reason why you should visit
                                        New
                                        Jersy</a></h3><a href="blog-details.html"
